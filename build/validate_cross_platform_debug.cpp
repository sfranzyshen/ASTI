...
int main(int argc, char* argv[]) {
    ...
    for (int testNumber = startTest; testNumber <= endTest; testNumber++) {
        ...
        std::cout << "Extracting C++ commands for test " << testNumber << "..." << std::endl;
        std::string cppCommands = extractCppCommands(testNumber);
        std::cout << "C++ extraction completed. Length: " << cppCommands.length() << std::endl;

        std::cout << "Loading JS commands for test " << testNumber << "..." << std::endl;
        std::string jsCommands = loadJsCommands(testNumber);
        std::cout << "JS loading completed. Length: " << jsCommands.length() << std::endl;
