/**
 * DeterministicMockProvider.hpp
 *
 * Reference implementation of SyncMockProvider with deterministic formulas.
 *
 * This implementation provides reproducible, formula-based mock values that
 * match the JavaScript MockDataManager for cross-platform test validation.
 *
...
/**
 * Deterministic mock provider using formulas matching JavaScript implementation
 */
class DeterministicMockProvider : public SyncMockProvider {
private:
...
public:
     ...
     */
    DeterministicMockProvider(uint32_t initialMillis = 17807,
